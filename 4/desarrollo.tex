...
\begin{itemize}
  ...
  \item \textbf{Precisión promedio:} 0.945, indicando que la mayoría de los píxeles se clasificaron correctamente.
  \item \textbf{Dice Score promedio:} 0.872, mostrando un nivel bueno de superposición entre máscaras predichas y reales.
  \item \textbf{Jaccard Index promedio:} 0.889, reflejando buenas coincidencias exactas en regiones complejas.
...
\begin{itemize}
  ...
  \item \textbf{Precisión promedio:} 0.931, indicando que gran parte de los píxeles se clasificaron correctamente.
