...
\vspace{2ex}
 ...
 Enseguida, se proporciona en la Figura \ref{3:fig6} el diagrama de cada actividad, y a su vez un detalle de la actividad junto con el entregable correspondiente que se espera obtener.
