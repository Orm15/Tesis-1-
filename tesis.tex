...
\fancypagestyle{special}{%
	\fancyhead[L]{\changefont Segmentación Avanzada de Características Morfológicas en la Piel del Rostro usando Redes Neuronales Convolucionales: Enfoque en Arrugas y Manchas}
	\fancyhead[R]{\thepage}}
...
\begin{titlepage}
	...
	\begin{center}
		...
		Asesor: Junior John Fabián Arteaga		
		\vfill
		Lima, \today 
